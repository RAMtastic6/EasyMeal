import { setReadNotification } from "../lib/database/notification";
...
export default function Notification(
	...
	const deleteNotification = async () => {
		// Send request to server to delete notification
		const result = await setReadNotification({ id: id });
		hook(id);
		console.log(result);
	}

	return (
		<div className="flex rounded-xl border-2 border-gray-100 bg-white justify-between">
